            ...
            child: Column(
              ...
              children: [
                _buildInfoCard(
                  ...
                  content: [
                    _buildInfoRow('Name', mahasiswa.nama),
                    _buildInfoRow('Student ID', mahasiswa.nim),
                    _buildInfoRow('Gender', mahasiswa.jenisKelamin),
                    _buildInfoRow('Entry Year', mahasiswa.tahunMasuk),
                    _buildInfoRow('Registration Type', mahasiswa.jenisDaftar),
                    _buildInfoRow('Current Status', mahasiswa.statusSaatIni),
                  ],
                ),
                const SizedBox(height: 16),
                _buildInfoCard(
                  ...
                  content: [
                    _buildInfoRow('University', mahasiswa.namaPt),
                    _buildInfoRow('University Code', mahasiswa.kodePt),
                    _buildInfoRow('Study Program', mahasiswa.prodi),
                    _buildInfoRow('Study Program Code', mahasiswa.kodeProdi),
                    _buildInfoRow('Education Level', mahasiswa.jenjang),
                  ],
                ),
              ],
            ),
